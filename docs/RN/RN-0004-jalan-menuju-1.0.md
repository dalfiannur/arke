...
- 2026-07-28: **Penghalang #3 selesai** → [RFC-0028](../RFC/RFC-0028-changelog-msrv-semver-policy.md) / [M-25](../MILESTONE_25.md). `CHANGELOG.md` (Keep a Changelog); **STD-0009 (MSRV)** + **STD-0010 (semver/deprecation)**; job CI `msrv`; uji pin `SCHEMA_VERSION`. **Temuan:** MSRV dikoreksi 1.86→**1.88** (kode pakai let-chain, stabil 1.88). **Ketiga penghalang bentuk-API selesai — 0.6.0 siap dirilis.** Setelah rilis + periode soak tanpa breaking baru, buka Milestone 1.0.
